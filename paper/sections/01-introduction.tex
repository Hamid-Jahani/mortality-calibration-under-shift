...
and~\ref{sec:actuarial} report the shift-regime results and their actuarial
reading; the stable-control and placebo columns remain pending and no claim
in this draft rests on them. Section~\ref{sec:discussion} pre-commits the
