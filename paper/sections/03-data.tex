...
a fresh download that matches the manifest. The bulk file carries fifty
population series: forty-one countries or areas plus the overlapping
sub-population and civilian variants that HMD publishes for France, Germany,
the United Kingdom and New Zealand. This is the first HMD vintage in which
...
deaths and exposures are missing at every age (the only genuinely missing
data in the shift training panel), so BEL trains on 1919--2019; without the
