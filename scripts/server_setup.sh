...
#   # copy the HMD bulk files into ./Dataset/ (see docs/DATA-PREREQS.md — the data
...
# ---- 2. data + gates ----------------------------------------------------
test -s Dataset/deaths/Deaths_1x1/Deaths_1x1.txt || { echo "Dataset/ missing — see docs/DATA-PREREQS.md"; exit 2; }
