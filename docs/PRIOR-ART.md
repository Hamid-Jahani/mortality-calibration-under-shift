...
A design review demanded a web-scale search behind the claim that
...
| 2 | Web search | `"conformal prediction" "mortality forecasting" Lee-Carter` | no direct application beyond generic LC material |
